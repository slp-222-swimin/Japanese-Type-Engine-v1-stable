...
const WORD_LIST = {
    ...
    length6: [
        ...
        { kana: "じぇねれーたー", kanji: "ジェネレーター" }, { kana: "すまーとふぉん", kanji: "スマートフォン" }, { kana: "せきゅりてぃ", kanji: "セキュリティ" }, { kana: "てくのろじー", kanji: "テクノロジー" },
        ...
        { kana: "さいばーすぺーす", kanji: "サイバースペース" }, { kana: "はっかー", kanji: "ハッカー" }, { kana: "いんふら", kanji: "インフラ" }, { kana: "めんてなんす", kanji: "メンテナンス" },
    ...
    length7plus: [
        ...
        { kana: "きゅうきょくのせんたく", kanji: "究極の選択" }, { kana: "ぜんじどうせんたくき", kanji: "全自動洗濯機" }, { kana: "すーぱーうるとらぐれーと", kanji: "スーパーウルトラグレード" },
...
window.addEventListener('keydown', (e) => {
    ...
    // While playing, forward key to engine
    // JPTE Handles space ignoring internally if ignoreSpace: true
